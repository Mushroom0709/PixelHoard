...
| 文档 | 内容 |
|---|---|
| [docs/CONTEXT.md](docs/CONTEXT.md) | 词汇锁 + 项目基线 + 决策索引 |
| [docs/glossary/glossary.md](docs/glossary/glossary.md) | 完整术语表 |
| [docs/domain/decision-log.md](docs/domain/decision-log.md) | D1-D83 全决策原文 |
...
| [docs/adr/0005-domain-model.md](docs/adr/0005-domain-model.md) | PostgreSQL schema |
| [docs/adr/0006-url-and-routing.md](docs/adr/0006-url-and-routing.md) | URL 形式与前端路由 |
| [docs/adr/0007-deployment.md](docs/adr/0007-deployment.md) | Docker Compose 部署拓扑 |
